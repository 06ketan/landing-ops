...
const lines = [
  { kind: "prompt", text: "uvx substack-ops mcp install cursor" },
  { kind: "stdout", text: "✓ wrote ~/.cursor/mcp.json (backup at .bak)" },
  { kind: "stdout", text: "✓ 26 tools registered. Restart Cursor." },
  { kind: "blank", text: "" },
  { kind: "user", text: "you ▸ get the unanswered comments on my latest post" },
  { kind: "assistant", text: "cursor ▸ found 3 threads. drafting replies…" },
  { kind: "tool", text: "  → propose_reply (token=a3f9b2)" },
  { kind: "assistant", text: "cursor ▸ \"Glad it landed — the trick was…\"" },
  { kind: "user", text: "you ▸ ship it" },
  { kind: "tool", text: "  → confirm_reply(token=a3f9b2) ✓" },
  { kind: "stdout", text: "✓ posted, audited, deduped. $0 in API fees." },
];
